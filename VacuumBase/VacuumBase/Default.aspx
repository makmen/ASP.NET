<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="VacuumBase.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Основное направление деятельности предприятия ООО &laquo;ВТТ&raquo; - весь спектр работ в области вакуумной техники и технологий. Цель создания фирмы – стремление к более полному и качественному подходу к разработке и изготовление вакуумной техники с новыми технологическими возможностями.
        ...
        <div class="ambitios_indent_left ambitios_picture">
            <img src="<%# GetUrl %>/Images/main1.jpg" alt="" />
        </div>
    ...
    <p>&nbsp;</p>
    <div class="ambitios_indent_right ambitios_picture"><img src="Images/main2.jpg" alt="" /></div>
