<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Contacts.aspx.cs" Inherits="WebVacuum.article.Contacts" %>

<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <h3 class="ambitios_uppercase">Контактная информация </h3>
    <div id="contact_form">
	    <div id="Note"></div>
        <asp:Literal ID="ltSuccess" runat="server" Visible="false">
            <div class="mess-top">
                <div class="fbok">
        ...
        <asp:Literal ID="ltError" runat="server" Visible="false">
	        <div class="mess-top">
		        <div class="error">
